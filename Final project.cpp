...
int main() {
    ...
    cout << "Search for 20: " << (tree.search(tree.root, 20) != NULL ? "Found" : "Not Found") << endl;
...
InOrder traversal: 10 20 25 50 60 70 80
PreOrder traversal: 50 20 10 25 70 60 80
PostOrder traversal: 10 25 20 60 80 70 50
Search for 20: Found
Delete 10
InOrder traversal after deletion: 20 25 50 60 70 80
 
code Exucution successfull.
...
Insert values 20 10 25 70 60 80
